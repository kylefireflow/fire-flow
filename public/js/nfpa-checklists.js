...
export const NFPA13_CHECKLISTS = {
  ...
  'Wet Pipe Sprinkler': [
    ...
    { code:'WP-06', label:'18-Inch Clearance Below Heads',   description:'Minimum 18-inch clearance maintained below all sprinkler deflectors.',                        type:'pass_fail', required:true,  nfpa:'NFPA 25 5.2.1' },
    { code:'WP-07', label:'Spare Heads + Wrench On Site',    description:'Minimum spare head supply and matching wrench accessible in labeled cabinet.',                 type:'pass_fail', required:true,  nfpa:'NFPA 25 5.4.1' },
    ...
    { code:'WP-10', label:'Drain Test Residual Pressure',     description:'Main drain residual pressure recorded.',                                                       type:'numeric',   required:false, nfpa:'NFPA 25 13.2.5', unit:'psi residual' },
  ...
  'Dry Pipe Sprinkler': [
    ...
    { code:'DP-02', label:'Air Pressure (system side)',       description:'Record current air pressure on the system side of the valve.',                                 type:'numeric',   required:true,  nfpa:'NFPA 25 13.3.2', unit:'psi' },
    { code:'DP-03', label:'Water Pressure (supply side)',     description:'Record water supply pressure below the clapper.',                                              type:'numeric',   required:true,  nfpa:'NFPA 25 13.3.2', unit:'psi' },
    ...
    { code:'DP-07', label:'Valve Room Temperature',           description:'Room temperature maintained above 40 degrees F (4 degrees C).',                               type:'pass_fail', required:true,  nfpa:'NFPA 25 4.1.3' },
    ...
    { code:'DP-09', label:'FDC Condition',                    description:'Accessible, capped, and unobstructed.',                                                        type:'pass_fail', required:true,  nfpa:'NFPA 25 6.3.1' },
  ...
  'Pre-Action Sprinkler': [
    ...
    { code:'PA-02', label:'Detection System Interface',       description:'Fire detection initiating circuit connected to pre-action releasing panel.',                  type:'pass_fail', required:true,  nfpa:'NFPA 25 13.4.2' },
    { code:'PA-03', label:'Supervisory Air Pressure',         description:'Record current supervisory air pressure in the piping.',                                       type:'numeric',   required:true,  nfpa:'NFPA 25 13.4.3', unit:'psi' },
  ...
  'Deluge System': [
    ...
    { code:'DL-02', label:'Detection Releasing Circuit',      description:'Automatic detection circuit functional and properly wired to releasing panel.',               type:'pass_fail', required:true,  nfpa:'NFPA 25 13.5.2' },
    { code:'DL-03', label:'Open Nozzle Condition',            description:'All open nozzles free of debris, properly aimed, and unobstructed.',                          type:'pass_fail', required:true,  nfpa:'NFPA 25 13.5.3' },
  ...
  'Backflow Preventer': [
    { code:'BF-01', label:'Inlet Shutoff Valve Open',         description:'Upstream shutoff valve fully open and supervised or locked.',                                  type:'pass_fail', required:true,  nfpa:'NFPA 25 12.1.1' },
    { code:'BF-02', label:'Outlet Shutoff Valve Open',        description:'Downstream shutoff valve fully open and supervised or locked.',                                type:'pass_fail', required:true,  nfpa:'NFPA 25 12.1.1' },
  ...
  'Control Valves': [
    ...
    { code:'CV-02', label:'Valves Locked or Supervised',      description:'Each valve is locked open or electrically supervised with trouble signal to panel.',          type:'pass_fail', required:true,  nfpa:'NFPA 25 13.2.2' },
    ...
    { code:'CV-04', label:'PIV / Butterfly Valve Condition',  description:'Post indicator or butterfly valve properly set; indicator reads OPEN.',                       type:'pass_fail', required:false, nfpa:'NFPA 25 13.2.4' },
  ...
  'Alarm Devices': [
    ...
    { code:'AD-03', label:'Pressure / Flow Switch',           description:'Electrical waterflow switches operational and wired to monitoring system.',                   type:'pass_fail', required:true,  nfpa:'NFPA 25 5.3.5' },
    ...
    { code:'AD-06', label:'Retard Chamber Drain',             description:'Retard chamber (if present) drains properly after test.',                                      type:'pass_fail', required:false, nfpa:'NFPA 25 5.3.7' },
  ...
  'Sprinkler Heads': [
    ...
    { code:'SH-03', label:'No Loaded or Damaged Heads',       description:'No heads with accumulated loading of dust or grease, or mechanical damage.',                  type:'pass_fail', required:true,  nfpa:'NFPA 25 5.2.1.3' },
    { code:'SH-04', label:'18-Inch Clearance Maintained',    description:'Minimum 18-inch clearance from deflector to top of storage or obstruction.',                  type:'pass_fail', required:true,  nfpa:'NFPA 25 5.2.1' },
    { code:'SH-05', label:'No Missing Heads',                 description:'No missing or removed heads; all escutcheon plates properly seated.',                         type:'pass_fail', required:true,  nfpa:'NFPA 25 5.2.2' },
    ...
    { code:'SH-07', label:'Spare Heads On Site',              description:'Minimum 6 spare heads of each type installed on site, with matching wrench.',                 type:'pass_fail', required:true,  nfpa:'NFPA 25 5.4.1' },
  ...
  'Piping & Hangers': [
    ...
    { code:'PH-02', label:'No Corrosion or MIC',              description:'No visible external corrosion, leaks, or microbiologically influenced corrosion staining.',   type:'pass_fail', required:true,  nfpa:'NFPA 25 14.2.2' },
