...
export const NFPA13_CHECKLISTS = {
  ...
  'Wet Pipe Sprinkler': [
    ...
    { code:'WP-06', label:'18-Inch Clearance', description:'18-inch clearance maintained below all sprinklers.', type:'pass_fail', required:true,  nfpa:'NFPA 25 5.2.1' },
    ...
    { code:'WP-08', label:'FDC Condition', description:'Fire department connection accessible, capped, unobstructed, and undamaged.', type:'pass_fail', required:true,  nfpa:'NFPA 25 6.3.1' },
    { code:'WP-09', label:'Riser Room Clear', description:'No storage or obstructions around riser or post indicator valve.', type:'pass_fail', required:false, nfpa:'NFPA 25 4.1.2' },
    { code:'WP-10', label:'Drain Test Residual Pressure', description:'Record residual pressure during main drain test.', type:'numeric', required:false, nfpa:'NFPA 25 13.2.5', unit:'psi' },
  ...
  'Dry Pipe Sprinkler': [
    ...
    { code:'DP-02', label:'Air Pressure (system side)', description:'Record current air pressure on the system side.', type:'numeric', required:true,  nfpa:'NFPA 25 13.3.2', unit:'psi' },
    ...
    { code:'DP-04', label:'Air/Water Differential Ratio', description:'Verify air-to-water ratio is within manufacturer spec (typically 6:1).', type:'pass_fail', required:true,  nfpa:'NFPA 25 13.3.2' },
    ...
    { code:'DP-07', label:'Valve Room Temperature', description:'Room temperature above 40 degrees F.', type:'pass_fail', required:true,  nfpa:'NFPA 25 4.1.3' },
  ...
  'Pre-Action Sprinkler': [
    ...
    { code:'PA-02', label:'Detection System Interface', description:'Fire detection circuit properly connected to pre-action releasing panel.', type:'pass_fail', required:true,  nfpa:'NFPA 25 13.4.2' },
  ...
  'Deluge System': [
    ...
    { code:'DL-03', label:'Nozzle Condition', description:'All open nozzles free of debris, properly aimed, and unobstructed.', type:'pass_fail', required:true,  nfpa:'NFPA 25 13.5.3' },
  ...
  'Control Valves': [
    ...
    { code:'CV-02', label:'Valves Locked or Supervised', description:'Each valve locked open or electrically supervised.', type:'pass_fail', required:true,  nfpa:'NFPA 25 13.2.2' },
    ...
    { code:'CV-04', label:'PIV or Butterfly Valve', description:'Post indicator or butterfly valve properly set; indicator reads OPEN.', type:'pass_fail', required:false, nfpa:'NFPA 25 13.2.4' },
  ...
  'Alarm Devices': [
    ...
    { code:'AD-02', label:'Alarm Gong or Bell Condition', description:'Mechanical alarm gong or bell free of damage and obstruction.', type:'pass_fail', required:false, nfpa:'NFPA 25 5.3.4' },
    { code:'AD-03', label:'Pressure or Flow Switch', description:'Electrical waterflow switches operational and wired to monitoring.', type:'pass_fail', required:true,  nfpa:'NFPA 25 5.3.5' },
  ...
  'Sprinkler Heads': [
    ...
    { code:'SH-03', label:'No Loaded or Damaged Heads', description:'No heads with dust, grease, or mechanical damage.', type:'pass_fail', required:true,  nfpa:'NFPA 25 5.2.1.3' },
    { code:'SH-04', label:'18-Inch Clearance', description:'Minimum 18-inch clearance from deflector to top of storage.', type:'pass_fail', required:true,  nfpa:'NFPA 25 5.2.1' },
    ...
    { code:'SH-07', label:'Spare Heads On Site', description:'Minimum 6 spare heads of each type with wrench on site.', type:'pass_fail', required:true,  nfpa:'NFPA 25 5.4.1' },
  ...
  'Piping & Hangers': [
    ...
    { code:'PH-06', label:'No Unauthorized Modifications', description:'No field modifications outside original design.', type:'pass_fail', required:true,  nfpa:'NFPA 25 4.1.2' },
