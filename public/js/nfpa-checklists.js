...
export const NFPA13_CHECKLISTS = {
  ...
  'Piping & Hangers': [
    ...
    { code:'PH-02', label:'No Corrosion / MIC', description:'No visible external corrosion, leaks, or microbiologically influenced corrosion staining.', type:'pass_fail', required:true,  nfpa:'NFPA 25 14.2.2' },
    ...
    { code:'PH-04', label:'Hanger Spacing Acceptable', description:'No spans exceeding NFPA 13 hanger intervals for pipe size.', type:'pass_fail', required:false, nfpa:'NFPA 13 17.4' },
